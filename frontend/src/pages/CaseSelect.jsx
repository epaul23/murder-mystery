...
function Intro({ onDone }) {
  ...
  return (
    <div style={{
      ...
      <p style={{
        fontSize: 13, letterSpacing: 8, color: '#5a4535', textTransform: 'uppercase',
        opacity: phase >= 1 ? 1 : 0, transition: 'opacity 1.2s',
      }}>Detective Agency</p>
      <h1 style={{
        fontSize: 'clamp(3rem, 10vw, 6rem)', color: '#e8e0d0', fontWeight: 400,
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 780, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', padding: '4rem 0 3rem' }}>
          ...
          <h1 style={{
            fontSize: 'clamp(2.5rem, 6vw, 4rem)', color: '#e8e0d0', fontWeight: 400,
            fontFamily: 'Georgia, serif', marginBottom: 8, letterSpacing: 2,
            textShadow: '0 0 60px rgba(139,115,85,0.2)',
          }}>
            Murder Mystery
          </h1>
          <p style={{ color: '#3a3530', fontSize: 13, letterSpacing: 2, marginBottom: 4 }}>By: EMIL PAUL</p>
            ...
            {cases.map((c, i) => (
              ...
              >
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
                    ...
                    <span style={{
                      ...
                      letterSpacing: 2, textTransform: 'uppercase', border: `1px solid ${DIFF_COLOR[c.difficulty]}33`,
                    }}>{c.difficulty}</span>
                  </div>
                  <h2 style={{
                    fontSize: 22, fontWeight: 400, color: hoveredId === c.id ? '#f0e8d8' : '#c8c0b0',
                    marginBottom: 8, fontFamily: 'Georgia, serif', transition: 'color 0.3s',
                  }}>{c.title}</h2>
                  <p style={{ fontSize: 13, color: '#3a3530', marginBottom: 4 }}>{c.setting}</p>
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  ...
                  <span style={{
                    fontSize: 18, color: hoveredId === c.id ? '#8b7355' : '#2a2520',

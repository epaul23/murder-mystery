// Case 1 briefing slides — all story data lives here
// To add/edit this case's story, only touch this file

export const case1Briefing = [
  {
    image: '/cases/case1/manor.png',
    layout: 'cinematic',
    overlay: 0.5,
    eyebrow: 'October 14th, 1923 — Devonshire, England',
    title: 'Blackwood Manor',
    body: 'A moonless night. The grounds are silent except for the wind through the iron gates. Somewhere inside, a man lies dead.',
    tag: null,
  },
  {
    image: '/cases/case1/study.png',
    layout: 'split-right',
    overlay: 0.6,
  ...
  {
    image: '/cases/case1/suspects.png',
    layout: 'cinematic',
    overlay: 0.55,
    eyebrow: 'Persons of Interest',
    title: 'Four Suspects.\nOne Killer.',
    body: 'Victoria Blackwood. Dr. Edmund Hale. Clara Finch. Reginald Cross. All were present at the manor that evening. All have something to hide.',
    tag: null,
  },
  {
